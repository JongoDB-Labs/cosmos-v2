...
// COSMOS-143 (Open Task/Item in Table View — Phase 3). A table row can be opened
// in the shared CardDetailSheet — the same rich editor Kanban uses, exposing
// description, status, assignee, priority, dates and more — and an edit made in
// that sheet is saved and immediately reflected in the corresponding table row
// (and survives closing the panel).
...
describe("TableView — open item in a detail side panel (COSMOS-143)", () => {
