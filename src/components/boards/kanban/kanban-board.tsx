...
function KanbanBoardInner({
  ...
  // Tags the filter control lists. NOT presentLabels(items): a SCRUM board is
  // this component seeded with the active sprint, so the raw fetch carries tags
  // that exist only outside it — listing those makes "pick a tag" a way to blank
  // the board. See tagFilterOptions.
