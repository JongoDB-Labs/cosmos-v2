...
import { exchangeClaudeCode } from "@/lib/ai/claude-subscription";

/**
 * Complete the per-org Claude-subscription OAuth: read the sealed PKCE cookie
 * (verifier + state), exchange the pasted code/URL for tokens, seal + store them
 * on OrgAiSettings, then delete the one-shot cookie. Gated by ORG_MANAGE_SETTINGS.
 */
