...
import { initiateForemanClaudeOAuth } from "@/lib/ai/foreman-claude-subscription";

/**
 * Begin Foreman's OWN per-org Claude-subscription OAuth (PKCE) flow. Mints the
 * verifier + state, stashes them SEALED in a short-lived httpOnly cookie the
 * exchange route validates against, and returns the Claude authorize URL the
 * admin visits.
 *
