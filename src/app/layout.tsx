...
// gets the runtime product's <title>/theme-color (e.g. PRODUCT=acme → "Acme",
...
// error). themeColor is a deferred one-image minor (cosmos accent on a acme
 ...
 * `skin-atelier` for Acme); the script corrects it at runtime if the
