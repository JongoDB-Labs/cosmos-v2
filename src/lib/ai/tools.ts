  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        startDate: { type: "string", description: "Start date as a calendar day YYYY-MM-DD (no time, no timezone)" },
      },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        dueDate: { type: "string", description: "Due date as a calendar day YYYY-MM-DD (no time, no timezone). Pass null to clear." },
        startDate: { type: "string", description: "Start date as a calendar day YYYY-MM-DD (no time, no timezone). Pass null to clear." },
